...
TEST_F(GDialSsdpTest, NewAndDestroy_BasicFlow) {
...
TEST_F(GDialSsdpTest, DdXmlRequest_ReturnsOk) {
    ...
    EXPECT_NE(strstr(app_url, "/appsxyz/"), nullptr);
...
TEST_F(GDialSsdpTest, Setters_UpdateDdXmlResponse) {
    const char *random_uuid = "appsset";
...
TEST_F(GDialSsdpTest, SetAvailableAndStandbyHandler_NoCrash) {
